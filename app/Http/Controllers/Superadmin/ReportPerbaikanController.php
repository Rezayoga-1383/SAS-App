...
class ReportPerbaikanController extends Controller
{
    ...
    {
        return view('superadmin.reportperbaikan');
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = \PDF::loadview('superadmin.reportperbaikanpdf', $data)
    ...
    {
        return view('superadmin.reportteknisi');
    }
    ...
    public function exportReportTeknisi(Request $request)
    {
        ...
        $pdf = \PDF::loadView('superadmin.reportteknisipdf', [
            'data' => $data,
            'start_date' => $start,
            'end_date' => $end
