        ...
        <div class="col-md-9">
          <form action="{{ route('spk.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="row gy-4">
              ...
              <div class="col-sm-6">
                <label for="waktu_mulai" class="form-label">Waktu Mulai Pengerjaan <span class="text-danger">*</span></label>
                <input
                    type="time"
                    id="waktu_mulai"
                    name="waktu_mulai"
              ...
              <div class="col-sm-6">
                <label for="waktu_selesai" class="form-label">Waktu Selesai Pengerjaan <span class="text-danger">*</span></label>
                <input
                    type="time"
                    id="waktu_selesai"
                    name="waktu_selesai"
              ...
              <div class="col-sm-6">
                <label for="jumlah_orang" class="form-label">Jumlah Teknisi <span class="text-danger">*</span></label>
                <input
                    type="number"
                    id="jumlah_orang"
                    name="jumlah_orang"
              ...
              <div class="col-sm-6">
                  <label for="pelaksana_ttd" class="form-label">Pelaksana SPK <span class="text-danger">*</span></label>
              ...
              <div class="col-sm-6">
                  <label for="file_spk" class="form-label">Upload File SPK <span class="text-danger">*</span></label>
                  <input
                      type="file"
                      id="file_spk"
                      name="file_spk"
