        ...
        columns: [
			...
			{ 
				...
				render: function(data) {
					return `
						<a href="/ruangan/${data}/edit" class="btn btn-md btn-success"><i class="align-middle" data-feather="edit"></i><strong>Edit</strong></a>
						<form action="/ruangan/${data}" method="POST" class="d-inline form-delete">
                            @csrf
                            @method('DELETE')
