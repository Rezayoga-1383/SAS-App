    ...
    <script>
        $(document).ready(function() {
            $('#TabelPengguna').DataTable({
                processing: true,
                serverside: true,
                ajax: "{{ route('superadmin.pengguna.data') }}",
                columns: [
                    {
                        data: null,
                        name: 'no',
                    ...
                    { data: 'role', name: 'role' },
                    {
                        ...
                        render: function(data) {
                            return `
                                <a href="/superadmin/pengguna/${data}/edit" class="btn btn-md btn-success"><i class="align-middle" data-feather="edit"></i><strong>Edit</strong></a>
                                <form action="/superadmin/pengguna/${data}" method="POST" class="d-inline form-delete">
                                    @csrf
                                    @method('DELETE')
