			...
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
                        ...
                        <form action="{{ route('superadmin.detailac.store') }}" method="POST" novalidate>
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="d-flex flex-column flex-md-row gap-2 justify-content-between align-items-md-center mt-4">
                                <a href="{{ route('superadmin.detailac') }}" class="btn btn-outline-secondary w-100 w-md-auto order-2 order-md-1">Batal</a>
