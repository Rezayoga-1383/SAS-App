...
<main class="content">
    <div class="page-content mt-n4">
        <div class="row">
            <div class="col-md-12 grif-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('superadmin.pengguna.update', $pengguna->id) }}" method="POST" novalidate>
                            @csrf
                            @method('PUT')

                            <div class="mb-3">
                                <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" id="email" name="email" value="{{ old('email', $pengguna->email) }}" required class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Masukkan Email Pengguna">
                                @error('email')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ old('nama', $pengguna->nama) }}" required class="form-control form-control-lg @error('nama') is-invalid @enderror" placeholder="Masukkan Nama Pengguna">
                                @error('nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
